...
public class PrintByImageTemplateMethodModelEx implements TemplateMethodModelEx {

    private final MarkDownUtils markDownUtils;

    public PrintByImageTemplateMethodModelEx(MarkDownUtils markDownUtils) {
        super();
    ...
    private Object execOneArg(Object arg) throws TemplateModelException {
        if (arg instanceof WrapperTemplateModel && ((WrapperTemplateModel) arg).getWrappedObject() instanceof Map) {
            ...
            return markDownUtils.printIssueByImage((Severity) (map.get("severity")), (String) map.get("message"), (String) map.get("ruleLink"), (String) map.get("url"), (String) map.get("componentKey"));
        }
        throw new TemplateModelException("Failed call accept 1 issue arg");
    }
}
