...
public abstract class AbstractRuleTypeTemplateMethodModelEx implements TemplateMethodModelEx {

    AbstractRuleTypeTemplateMethodModelEx() {
        super();
    }
    ...
    protected abstract Object exec(String ruleType);
