 ...
 * 根据问题类型查询
 */
public class IssuesTypeTemplateMethodModelEx extends AbstractIssuesTypeTemplateMethodModelEx {

    public IssuesTypeTemplateMethodModelEx(List<ReportIssue> reportIssues) {
        super(reportIssues);
    }
